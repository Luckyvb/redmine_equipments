...
if Rails::VERSION::STRING < '5.0.0'
  ...
  module Redmine::WikiFormatting::Markdown::Helper
    def heads_for_wiki_formatter_with_equipments
      heads_for_wiki_formatter_without_equipments
    ...
    #alias_method_chain :heads_for_wiki_formatter, :equipments
    alias_method :heads_for_wiki_formatter_without_equipments, :heads_for_wiki_formatter
    alias_method :heads_for_wiki_formatter, :heads_for_wiki_formatter_with_equipments
  end
else
  # Rails 5, use new new `prepend` method
  module Equipments_markdown
